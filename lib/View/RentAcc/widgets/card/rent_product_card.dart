...
class RentProductCard extends StatelessWidget {
  final RentProductModel product;
  final GlobalKey widgetKey = GlobalKey();
  final int index;
  final void Function(GlobalKey)  onClick;
   RentProductCard({super.key, required this.product, required this.index, required this.onClick});

  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.sizeOf(context);
    final cart = Provider.of<RentCartProvider>(context, listen: true); // Listen to cart changes
    final buycart = Provider.of<CartProvider>(context, listen: false); // CartProvider

    // Check if the product is already in the cart
    final isInCart = cart.itemsRent.any((item) => item.id == product.id);
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        // Conditionally show Rent button or Increment/Decrement buttons
                        isInCart
                            ? Row(
                          children: [
                            GestureDetector(
                                        ...
                                        child: Opacity(
                                          ...
                                          child: AlertDialog(
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      'Your buy cart contains items. Do you want to clear the buy cart to add this item to your purchase cart?',
                                                      style: GoogleFonts.poppins(
                                                        fontSize: 16,
                                            ...
                                            actions: [
                                              ...
                                              ElevatedButton(
                                                onPressed: () {
                                                  buycart.clearCart(); // Clear rent cart
                                                  Navigator.pop(context); // Close dialog
                                                  // Add item to CartProvider
                                                  RentCartModel cartModel = RentCartModel(
                                                    id: product.id!,

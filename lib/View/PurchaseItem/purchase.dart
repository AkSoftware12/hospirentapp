...
import 'package:hospirent/View/PurchaseItem/OrderDetails/purchase_order_details.dart';
...
class _MyServiceScreenState extends State<PurchaseOrdersScreen> {
  ...
  Future<void> fetchOrders() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(ApiRoutes.getOrderPurchaseList),
        headers: {
                          ...
                          children: [
                            if (widget.order['status'].toLowerCase() == 'confirmed') ...[
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  final Uri uri = Uri.parse('${ApiRoutes.customerPurchaseChallanPrint}${ widget.order['id']}');
                                  try {
